...
import com.tech.tsang.wistrom.WEncrypt;
...
public class WUserApi extends WiStormApi {
	 ...
	 * @param onFailure 连接失败回调
	 */
	public void isExist(String mobile,OnSuccess onSuccess,OnFailure onFailure){
		HashMap<String, String> params = new HashMap<String, String>();
	 ...
	 * @param onFailure   连接失败回调
	 */
	public void passwordReset(String account, String password, String validType,
